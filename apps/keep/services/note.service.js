...
function _createNotes() {
    ...
    if (!notes || !notes.length) {
        ...
        notes.push(_createNote("note-todo", false, {
            label: "Shopping List",
            todos: [{ txt: "Milk", doneAt: null }, { txt: "Eggs", doneAt: 177111111 }, { txt: "Bread", doneAt: null },]
        }))
        ...
        notes.push(_createNote('note-video', false, { url: 'https://www.youtube.com/watch?v=qZXt1Aom3Cs&ab_channel=TraversyMedia', title: '' }, null))
        notes.push(_createNote('note-video', false, { url: 'https://www.youtube.com/watch?v=dCYDZDlcO6g&ab_channel=TaylorTries', title: '' }, null))
